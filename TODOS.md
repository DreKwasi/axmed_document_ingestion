...
- [x] **DI-09: Delivery hardening** — CI workflow, Playwright E2E smoke tests, automated PII audit, submission documentation, and docs update. Evidence: `docs/worksheets/di-09-delivery-hardening.md`.
